...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ValidateJWT = channel.unary_unary(
                '/UserService/ValidateJWT',
                request_serializer=protos_dot_user__pb2.ValidateJWTRequest.SerializeToString,
                response_deserializer=protos_dot_user__pb2.ValidateJWTResponse.FromString,
                )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ValidateJWT': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=protos_dot_user__pb2.ValidateJWTRequest.FromString,
                    response_serializer=protos_dot_user__pb2.ValidateJWTResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def ValidateJWT(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/UserService/ValidateJWT',
            protos_dot_user__pb2.ValidateJWTRequest.SerializeToString,
            protos_dot_user__pb2.ValidateJWTResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
